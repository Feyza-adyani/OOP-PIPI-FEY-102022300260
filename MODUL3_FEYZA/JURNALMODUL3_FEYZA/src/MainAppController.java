...
public class MainAppController {
    ...
    public void initialize() {
        ...
        titleCol.setCellFactory(new PropertyValueFactory("title"));
        priorityCol.setCellFactory(new PropertyValueFactory("priority"));
        statusCol.setCellFactory(new PropertyValueFactory("status"));
        dueDateCol.setCellFactory(new PropertyValueFactory("dueDate"));
    ...
    private void addTask() {
        try {
            ...
            if (titleField.getText().isEmpty() || priorityBox.getValue() == null || dueDatePicker.getValue() == null) {
                ...
                throw new MissingFieldException("Semua field belum terisi!");
            }
    ...
    private void markTaskComplete() {
        try {
            ...
            if (selected == null) {
                // TODO: Throw new TaskNotSelectedException dengan pesan yang sesuai 
                throw new TaskNotSelectedException("Belum ada task yg dipilih")
            }
